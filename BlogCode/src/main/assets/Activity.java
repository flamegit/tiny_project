 ...
 * onDestroy().  For example, if it has a thread running in the ad_background
 ...
 * in such a ad_background state, allowing you to save away any dynamic instance
 ...
 * <li> <p>A <b>ad_background activity</b> (an activity that is not visible to
 ...
 * ad_background operation you do outside of an activity must be executed in the
...
public class Activity extends ContextThemeWrapper
     ...
     * in the ad_background or on its way to destruction, or {@link #onStop} which
     ...
     * the ad_background, but has not (yet) been killed.  The counterpart to
     * {@link #onResume}.
     *
     ...
     * into the ad_background as the result of user choice.  For example, when the
     ...
     * {@link #setProgress(int)} and the ad_background. It can be ideal for media
     ...
     * <p>
     * Call this whenever the ad_background of a translucent Activity has changed to become opaque.
    ...
    public interface TranslucentConversionListener {
         ...
         *
         * @param drawComplete True if the ad_background Activity has drawn itself. False if a timeout
